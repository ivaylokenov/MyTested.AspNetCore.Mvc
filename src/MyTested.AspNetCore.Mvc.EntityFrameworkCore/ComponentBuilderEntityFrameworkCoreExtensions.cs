namespace MyTested.AspNetCore.Mvc
{
    ...
    /// <summary>
    /// Contains <see cref="DbContext"/> extension methods for <see cref="IBaseTestBuilderWithComponent{TBuilder}"/>.
    /// </summary>
    public static class ComponentBuilderEntityFrameworkCoreExtensions
    {
        ...
        /// <param name="builder">Instance of <see cref="IBaseTestBuilderWithComponent{TBuilder}"/> type.</param>
        ...
        public static TBuilder WithDbContext<TBuilder>(
            this IBaseTestBuilderWithComponent<TBuilder> builder,
            Action<IDbContextBuilder> dbContextBuilder)
            where TBuilder : class
        {
            var actualBuilder = (BaseTestBuilderWithComponent<TBuilder>)builder;
