namespace MyTested.AspNetCore.Mvc.Builders.Contracts.Http
{
    ...
    public interface IResponseCookieTestBuilder
    {
        ...
        /// <returns>The same <see cref="IAndResponseCookieTestBuilder"/>.</returns>
        IAndResponseCookieTestBuilder WithExpires(DateTimeOffset? expires);
        ...
        /// <summary>
        /// Tests whether the <see cref="Microsoft.Net.Http.Headers.SetCookieHeaderValue.SameSite"/> property is the same as provided one.
        /// </summary>
        /// <param name="sameSite">Expected <see cref="Microsoft.Net.Http.Headers.SetCookieHeaderValue.SameSite"/> property of the cookie.</param>
        /// <returns>The same <see cref="IAndResponseCookieTestBuilder"/>.</returns>
