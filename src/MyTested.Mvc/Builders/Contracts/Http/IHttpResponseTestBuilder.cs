namespace MyTested.Mvc.Builders.Contracts.Http
{
    ...
    public interface IHttpResponseTestBuilder : IBaseTestBuilderWithInvokedAction
    {
        ...
        /// <summary>
        /// Tests whether <see cref="HttpResponse"/> content length is the same as the provided one.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether <see cref="HttpResponse"/> content type is the same as the provided one.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether <see cref="HttpResponse"/> contains cookie with the same name as the provided one.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether <see cref="HttpResponse"/> contains cookie with the same name and value as the provided ones.
        /// </summary>
        /// <param name="name">Expected cookie name.</param>
        ...
        /// <summary>
        /// Tests whether <see cref="HttpResponse"/> contains cookie with the same name, value and options as the provided ones.
        /// </summary>
        /// <param name="name">Expected cookie name.</param>
        /// <param name="value">Expected cookie value.</param>
        ...
        /// <summary>
        /// Tests whether <see cref="HttpResponse"/> contains cookie by using test builder.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether <see cref="HttpResponse"/> contains the provided dictionary of cookies.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether <see cref="HttpResponse"/> contains header with the same name as the provided one.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether <see cref="HttpResponse"/> contains header with the same name and value as the provided ones.
        /// </summary>
        /// <param name="name">Expected header name.</param>
        ...
        /// <summary>
        /// Tests whether <see cref="HttpResponse"/> contains header with the same name and values as the provided ones.
        /// </summary>
        /// <param name="name">Expected header name.</param>
        ...
        /// <summary>
        /// Tests whether <see cref="HttpResponse"/> contains the same headers as the provided ones.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether <see cref="HttpResponse"/> status code is the same as the provided one.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether <see cref="HttpResponse"/> status code is the same as the provided HttpStatusCode.
        /// </summary>
        /// <param name="statusCode">Expected status code.</param>
        /// <returns>The same <see cref="IAndHttpResponseTestBuilder"/> test builder.</returns>
