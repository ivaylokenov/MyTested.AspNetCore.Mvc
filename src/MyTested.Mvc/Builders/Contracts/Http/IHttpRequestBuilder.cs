namespace MyTested.Mvc.Builders.Contracts.Http
{
    ...
    {
        /// <summary>
        /// Adds body to the built <see cref="HttpRequest"/>.
        /// </summary>
        /// <param name="stream">Body as <see cref="Stream"/>.</param>
        /// <returns>The same <see cref="IAndHttpRequestBuilder"/>.</returns>
        IAndHttpRequestBuilder WithBody(Stream body);

        /// <summary>
        /// Adds body to the built <see cref="HttpRequest"/> by trying to format the provided object based
        ...
        /// <summary>
        /// Adds string body to the built <see cref="HttpRequest"/>. If no content type is set on the request,
        ...
        /// <summary>
        /// Adds string body to the built <see cref="HttpRequest"/>. If no content type is
        ...
        /// <summary>
        /// Adds JSON body to the built <see cref="HttpRequest"/>. Sets 'application/json' to the content type. Uses <see cref="Encoding.UTF8"/> encoding.
        /// </summary>
        ...
        /// <summary>
        /// Adds JSON body to the built <see cref="HttpRequest"/>. If no content type is set on the request, 'application/json' will be used.
        /// </summary>
        /// <param name="jsonBody">JSON body as string.</param>
        /// <param name="encoding"><see cref="Encoding"/> to use for the body.</param>
        /// <returns>The same <see cref="IAndHttpRequestBuilder"/>.</returns>
        ...
        /// <summary>
        /// Adds JSON body to the built <see cref="HttpRequest"/>. If no content type is set on the request, 'application/json' will be used. Uses <see cref="Encoding.UTF8"/> encoding.
        /// </summary>
        ...
        /// <summary>
        /// Adds content length to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds content type to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds cookie to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds cookies to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds form field to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds form fields to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds form file to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds form files to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds form values and files to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds header to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds collection of headers to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds host to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds method to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds path to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds path base to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds protocol to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds query value to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds collection of query values to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds query string to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds scheme to the built <see cref="HttpRequest"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds HTTPS scheme to the built <see cref="HttpRequest"/>.
        /// </summary>
        /// <returns>The same <see cref="IAndHttpRequestBuilder"/>.</returns>
        IAndHttpRequestBuilder WithHttps();

        /// <summary>
        /// Adds all URI components to the built <see cref="HttpRequest"/> by extracting them from the provided location.
        /// </summary>
