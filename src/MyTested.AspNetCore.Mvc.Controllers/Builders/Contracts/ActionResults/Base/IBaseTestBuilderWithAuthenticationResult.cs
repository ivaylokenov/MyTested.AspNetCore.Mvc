namespace MyTested.AspNetCore.Mvc.Builders.Contracts.ActionResults.Base
{
    ...
    /// <summary>
    /// Base interface for all test builders with authentication <see cref="ActionResult"/>.
    /// </summary>
    ...
    {
        /// <summary>
        /// Tests whether the authentication <see cref="ActionResult"/> contains specific authentication scheme provided by string.
        /// </summary>
        /// <param name="authenticationScheme">Expected authentication scheme as string.</param>
        /// <returns>The same authentication <see cref="ActionResult"/> test builder.</returns>
        TAuthenticationResultTestBuilder ContainingAuthenticationScheme(string authenticationScheme);

        /// <summary>
        /// Tests whether the authentication <see cref="ActionResult"/> has the provided collection of authentication schemes.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the authentication <see cref="ActionResult"/> has the provided parameters of authentication schemes.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the authentication <see cref="ActionResult"/> has the provided <see cref="AuthenticationProperties"/>.
        /// </summary>
        ...
        /// <summary>
        /// Tests whether the authentication <see cref="ActionResult"/> has the given <see cref="AuthenticationProperties"/> provided as builder.
        /// </summary>
